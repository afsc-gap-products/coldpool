...
ebs_csv_path <- here::here("data", paste0(Sys.Date(), "_index_hauls_temperature_data.csv"))
nbs_ebs_csv_path <- here::here("data", paste0(Sys.Date(), "_ebs_nbs_temperature_full_area.csv"))
