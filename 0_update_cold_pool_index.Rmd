...
csv_path <- here::here("data", "2021-09-24_index_hauls_temperature_data.csv")
```
...
cpa_df <- interpolate_gear_temp(temp_data_path = csv_path,
                                proj_crs = proj_crs,
...
if(update_sysdata) {
  ...
  ebs_summer_temperature <- coldpool::make_raster_stack(file_path = here::here("output", "raster"),
